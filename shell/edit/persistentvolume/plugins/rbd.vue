  ...
  <div>
    <div class="row mb-20">
      <div class="col span-6">
        <LabeledInput
          v-model:value="value.spec.rbd.user"
          :mode="mode"
      ...
      <div class="col span-6">
        <LabeledInput
          v-model:value="value.spec.rbd.keyring"
          :mode="mode"
    ...
    <div class="row mb-20">
      <div class="col span-6">
        <LabeledInput
          v-model:value="value.spec.rbd.pool"
          :mode="mode"
      ...
      <div class="col span-6">
        <LabeledInput
          v-model:value="value.spec.rbd.image"
          :mode="mode"
    ...
    <div class="row mb-20">
      <div class="col span-6">
        <LabeledInput
          v-model:value="value.spec.rbd.secretRef.name"
          :mode="mode"
      ...
      <div class="col span-6">
        <LabeledInput
          v-model:value="value.spec.rbd.secretRef.namespace"
          :mode="mode"
    ...
    <div class="row mb-20">
      <div class="col span-6">
        <LabeledInput
          v-model:value="value.spec.rbd.fsType"
          :mode="mode"
      ...
      <div class="col span-6">
        <RadioGroup
          v-model:value="value.spec.rbd.readOnly"
          name="readOnly"
          :mode="mode"
    ...
    <div class="row mb-20">
      <div class="col span-6">
        <ArrayList
          v-model:value="value.spec.rbd.monitors"
