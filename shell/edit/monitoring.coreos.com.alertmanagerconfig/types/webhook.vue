...
export const MS_TEAMS_URL = 'http://demo-alerting-drivers-prom2teams.llmos-monitoring-system.svc:8089/v2/connector';
export const ALIBABA_CLOUD_SMS_URL = 'http://demo-alerting-drivers-sachet.llmos-monitoring-system.svc:9876/alert';
...
<template>
  <div>
    <Banner
      v-if="mode !== view && selectedWebhookType !== 'generic'"
