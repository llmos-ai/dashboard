...
export default {
  ...
  components: {
    LabeledSelect, UnitInput, RadioGroup, Checkbox
  },
  ...
  async fetch() {
    const hash = await allHash({
      storageClasses:    this.$store.dispatch('management/findAll', { type: STORAGE_CLASS }),
      persistentVolumes: this.$store.dispatch('management/findAll', { type: PV }),
    });
